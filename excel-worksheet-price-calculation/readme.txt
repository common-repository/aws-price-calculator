=== Excel Worksheet Price Calculation===
Contributors: altoswebsolutions
...
Excel Worksheet Price Calculation, the extension to give a price of product according to its characteristics with mathematical formulas.
== Description ==

Excel Worksheet Price Calculation is an intuitive and easy to use tool which allows you to import excel formulas directly into your WordPress site which you can then later use to calculate the exact price for your products.
Using the plugin is easy - all you have to do is import the Excel file containing the formulas, match the input and output fields using our easy-to-use interface, and that's it!

[youtube https://www.youtube.com/watch?v=v8WQBy-CJ60]

Excel Worksheet Price Calculation Light lets you:

- Create 5 fields
- 1 custom theme

For those who need more, Excel Worksheet Price Calculation can go PRO (https://altoswebsolutions.com/cms-plugins/woopricecalculator) and add a series of functions and tools that were developed to simplify your job and improve the customers' experience:
...
1. Unzip the files and upload the `excel-worksheet-price-calculation` folder into the `/wp-content/plugins/` directory
...
Read our faq here: https://altoswebsolutions.com/faq/woo-price-calculator
...
= 2.6.3 =
1. Compatible with Wordpress latest version.
2. Name Change.
3. Session handler.
4. Clean up.
