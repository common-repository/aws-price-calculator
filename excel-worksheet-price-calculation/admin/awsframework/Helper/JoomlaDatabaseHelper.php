...
class DatabaseHelper {
    ...
    /**
     * Get the database according to the target platform
     *
     * @return object
     */
    ...
    /**
     * Gets the table prefix according to the target platform
     *
     * @return string
     */
    ...
    public function prepareQuery($query, $params = array(), $forceStringParams = false){
         ...
         * 
         * In this way they will be replaced by the longer one to the smaller one, 
         * because it could happen that part of "Valore_111" is mistakenly replaced by "Valore_1"
         */
