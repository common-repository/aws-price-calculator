        ...
        <div class="col-sm-8">
            ...
            <div class="row">
                <div class="col-xs-12 text-center">
                    ...
                    <input id="import_from_file" value="Import from file" type="submit" formaction="<?php echo $this->adminUrl(array('controller' => 'field', 'action' => 'importFile', 'type' => "imagelist", 'id' => sanitize_text_field($_GET['id']))); ?>" class="btn btn-success">
